...
** PHP
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package ggtags :defer t :ensure t
       :init (add-hook 'php-mode-hook #'ggtags-mode)
       :config
...
** Javascript
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package js2-mode :ensure t :defer t :mode "\\.\\(g\\|j\\)s\\'" :interpreter "node" :config (setq js2-basic-offset 2))
...
* Useful Packages
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package evil :ensure t :init (evil-mode) (add-to-list 'evil-emacs-state-modes 'eshell-mode))
...
* Preferences
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package doom-themes :load-path "site-lisp/emacs-doom-themes" :init (require 'doom-themes) (load-theme 'doom-one t))
  #+END_SRC
